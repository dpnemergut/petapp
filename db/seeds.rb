...
users = [{:username => 'Santoshi', :email => 'santoshi.nitya@gmail.com', :password => 'hello', :password_confirmation => 'hello', :petid => 'p01'},
         {:username => 'Gayathri', :password => 'signal1', :password_confirmation => 'signal1', :petid => 'p02'},
  	 ]
